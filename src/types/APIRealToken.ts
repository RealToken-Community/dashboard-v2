...
export enum APIRealTokenEnv {
  COMMUNITY_API_KEY = 'COMMUNITY_API_KEY',
  AUTH = 'X-AUTH-REALT-TOKEN',
  API_BASE = 'REALTOKEN_API_BASE',
  VERSION = 'REALTOKEN_API_VERSION',
  GET_ALLTOKENS = 'REALTOKEN_API_GET_ALLTOKENS',
  API_HISTORY = 'REALTOKEN_API_HISTORY_BASE',
}
